...
\end{align*}
\newline
Dabei gilt $\| f \|_{\infty} \leq \| f \|_{2}$ , aber bei:$\hspace{0.25cm} f_n(t) = Todo:Bild$, folgt: \\
...
\]
 ...
 \begin{enumerate}[label=\alph*\upshape)]
	...
	\item Der Fall $l^{\infty}$: \\
		...
		\begin{beweis}
			"\ $\Rightarrow$ "\  Sei $T \in B(l^{\infty}), k \in \MdN$. Setze dann $x^{(k)} = \begin{cases} \frac{|a_{kl}|}{a_{kl}} & a_{kl} \neq 0 \\ 0 & a_{kl} = 0 \end{cases}$ \\
