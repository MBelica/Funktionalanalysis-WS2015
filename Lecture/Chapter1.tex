...
\begin{definition}
	...
	\begin{enumerate}[label=\alph*\upshape)] \index{Abschluss} \index{Innere} \index{Rand}
		...
		\item $\circ V := \bigcup \{ U \subset M: U$ ist offen mit $U \subset V \}$ das \textbf{Innere} von $V$. %todo circ
		\item $ \partial V := \bar V \ \circ V$ der \textbf{Rand} von $V$. % \circ
	\end{enumerate}
\end{definition}
	...
	\begin{enumerate}[label=\alph*\upshape)]
		\item
			\begin{enumerate}
				...
				\item $\bar V = \{ x \in M: \exists (x_{n}) \subset V$ mit $\lim_{n \rightarrow \infty} x_{n} = x \} =: \tilde V$ %todo tilde above
			\end{enumerate} 
		\item 
			\begin{enumerate}
				\item $\circ V$ ist die grö{\ss}te offene Teilmenge von $V$. %todo circ above
				\item $V$ ist offen $\gdw V = \circ V$ %todo circ above
				\item $\circ V = \{ x \in M: \exists \epsilon > 0$ mit $K(x, \epsilon) \subset V \} = \tilde \tilde V$ %todo tilde tilde above
			\end{enumerate} 
		\item
			\begin{enumerate}
...
\begin{beispiel}
	\begin{enumerate}[label=\alph*\upshape)]
		...
		Nach Beispiel 3.15 ist $\psi$ stetig. D.h. ist $A \subset \MdK$ offen (abgeschlossen), so ist $\psi(A)$ offen (abgeschlossen).
	\end{enumerate}	
\end{beispiel}
