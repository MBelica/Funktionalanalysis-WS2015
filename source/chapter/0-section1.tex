...
\begin{beispiel}
	...
	\begin{figure}[H]
		\pgfmathdeclarefunction{xnfct}{1}{ \pgfmathparse{(x^( #1 ))}}	
		\begin{center}					
			\begin{tikzpicture}
				\begin{axis}[
					domain=0:1,
					...
					\addplot [color= blue, thin, dashed, smooth] {xnfct(3)};
					\addplot [color= blue, thin, dashed, smooth] {xnfct(8)};
					\addplot [color= blue, thin, dashed, smooth] {xnfct(20)};
					\addplot [color= blue, thin, dashed, smooth] {xnfct(50)};
				\end{axis}
			\end{tikzpicture}
...
\begin{enumerate}
	\item Fredholm'sche Integralgleichungen \index{Fredholm'sche Integralgleichung} \\
