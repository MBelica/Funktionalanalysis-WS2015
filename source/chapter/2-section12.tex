...
\begin{beispiel}
	\begin{enumerate}[label=\alph*\upshape)]
		...
		\item $X = L	^{p}[0, 1],$ $B x(t) = \frac{1}{t} x(t)$.
			\[ D(B) = \{ x \in L^{p}([0, 1]): \exists \epsilon(x), x = 0 \text{ fast überall auf } [0, \epsilon] \}\] %todo: check at 12.1 if it is really x = 0
			$B$ bildet nach $X$ ab, denn $\| B x \|_{L^{p}} = \left( \int_{\epsilon}^{1} t^{-p} |x(t)|^{p} dt \right)^{\frac{1}{p}} \leq \frac{1}{\epsilon(x)} \| x \|_{L^{p}}$ \\ \\
			z.B.: $x_{\lambda} = \mathds{1}_{[\frac{1}{\lambda}, 1]} \Rightarrow \| x_{\lambda}\|_{L^{p}} = \left( \int_{\frac{1}{\lambda}}^{1} |x_{\lambda}(t)|^{p} dt \right)^{\frac{1}{p}} = \left( \int_{\frac{1}{\lambda}}^{1} dt \right)^{\frac{1}{p}} < 1$
...
\begin{satz} \label{satz:12.3}
	...
	\begin{enumerate}[label=\alph*\upshape)]
		...
		\item $\operatorname{graph}(A) = \{ (x, A x): x \in D(A) \} \subset X \times X$ ist abgeschlossen
...
\begin{beweis}
	$a) \Rightarrow b)$ $J: D(A) \rightarrow X \times X, J(x) = (x, Ax)$. Dann gilt
		...
		$\Rightarrow \operatorname{graph}(A) = \bild(J)$ ist vollständig $\Rightarrow \operatorname{graph}(A)$ ist abgeschlossen. \\ \\
	$b) \Rightarrow c)$ Sei $(x_{n})_{n} \subset D(A)$ mit $x_{n} \xrightarrow[]{n \rightarrow \infty} x$ und $Ax_{n} \xrightarrow[]{n \rightarrow \infty} y$ in $X$.
		...
		$\xRightarrow[]{A \text{abg.}} (x, y) \in \operatorname{graph}(A) \Rightarrow x \in D(A), Ax = y$. \\ \\
...
\begin{beweis}
	...
	\[ \xRightarrow[]{10.6} \exists c > 0: \| x \|_{A} \leq c \| x \| \forall x \in X \] % todo: check at 12.6.5: it refers to 10.6 but that is missing in my notes
	...
	\begin{enumerate}[label=\alph*\upshape)]
		...
		\item $X = L^{p}[0, 1], A x(t) = \frac{1}{t} x(t), t \in [0, 1]$
			...
			\begin{beweis}[Beweisverfahren Klausurrelevant!]
				...
				Beweis: $x_{n}(t) = \begin{cases} t & \text{ auf } (\frac{1}{n}, 1) \\ 0 & \text{ auf } [0, \frac{1}{n}]\end{cases},$ $y(t) = 1, \forall t \in [0, 1]$ \\
					\[ \Rightarrow x(t) = t \quad t \in [0, 1] \]
					Dann
					\begin{align*}
					...
					\end{align*}
					Aber $x \neq D_{1} \Rightarrow A$ ist nicht abgeschlossen.
			\end{beweis}
	\end{enumerate}
\end{beispiel}
