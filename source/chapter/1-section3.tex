...
\begin{beweis}
	\begin{description}
		...
		\[
		 ...
		 \item[] $c) \Rightarrow d)$ Sei $T(U_{X}) \subset c U_{Y}$ \\
...
\begin{beweis}
	...
	Die Beschränktheit erhalten wir mittels
	\begin{align*}
		\| ( T + S )(x) \| = \| Tx + Sx \| &\leq \| Tx \| + \| Sx \| \\
										   &\leq \| T \| + \| S \|
	\end{align*}
	Bilden des Supremums über $\| x \| \leq 1$ liefert:
	\[ \| T + S \| \leq \| T \| + \| S \|. \]
	Für $X = Y$ und $x \in X$ gilt
	\begin{align*}
...
\begin{definition}
	...
	\begin{enumerate}[label=\alph*\upshape)]
		...
		\item $T$ hei{\ss}t \begriff{Isometrie}, falls $ \| Tx \|_{Y} = \| x \|_{X}, ~ \forall x \in X $
...
\begin{beispiel}
	...
	Die Abbildung
	\[ \Phi_{p} \colon \ell^{q} \rightarrow (\ell^{p})', \hspace{0.25cm} [\Phi_{p}(x)](y) = \sum_{n = 1}^{\infty} x_{n} y_{n}, \hspace{0.25cm} x \in \ell^{q}, y \in \ell^{p}  \]
