...
\begin{bemerkung} \label{bem:4.5}
	\begin{enumerate}[label=\alph*\upshape)] 
		...
		\item Bezüglich der diskreten Metrik $d$ aus \hyperref[bsp:1-diskreteMetrik]{Beispiel 4.2 b)} ist $O = \{x\} \subset M$ offen für jedes $x \in M$, da
			\[ K(x, r) = \{ x \} \subseteq O \text{ für } r \in [0, 1) \]
	\end{enumerate}	
\end{bemerkung}
