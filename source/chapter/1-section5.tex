...
\begin{bemerkung}[Exponentialfunktion]
	Sei $A \in B(X)$, wobei $X$ ein Banachraum ist.
	\begin{itemize}
		\item Frage: $e^{tA} \in B(X) $
		\item Idee: $e^{tA} = \sum_{n = 0}^{\infty} \frac{1}{n!} t^{n} A^{n}$
	\end{itemize}
	Setze $S_{m} \coloneqq \sum_{n = 0}^{m} \frac{1}{n!} t^{n} A^{n}$ und seien $k, m \in \MdN, k > 0$.
...
\begin{definition} \label{def:5.15-Lipschitz}
	$f \colon M \rightarrow \MdR$ hei{\ss}t \begriff{Lipschitz}, falls:
