...
\begin{definition}
	Sei $(M, d)$ ein metrischer Raum. Ein vollständiger metrischer Raum $(\hat M, \hat d)$ hei{\ss}t \begriff{Vervollständigung} von $(M, d)$, falls es eine Einbettung $J : M \rightarrow \hat M$ gibt mit:
