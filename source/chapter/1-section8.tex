...
\begin{bemerkung*}
	$D \subseteq L^{p}(\MdR^{d})$ dicht, z.B.: $D = \{ f \in L^{\infty}(\MdR^{d}): \operatorname{supp}(f)$ comp. $\}$ % todo check if thats right
...
\begin{kor} \label{kor:8.9}
	...
	\begin{beweis}
		...
		\[ \Rightarrow \operatorname{supp}(g) \ast \phi_{\delta} \leq A + V(0, \frac{delta_{0}}{2} \subset \Omega \text{ für } \delta < \frac{\delta_{0}}{2} \]
