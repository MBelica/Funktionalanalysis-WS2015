...
\begin{definition}[Bedingter Erwartungsoptor] \index{Bedingter Erwartungsoptor}
...
\begin{bemerkung*}
	$D \subseteq L^{p}(\MdR^{d})$ dicht, z.B.: $D = \{ f \in L^{\infty}(\MdR^{d}): supp f$ comp. $\}$ % todo check if thats right
...
\begin{beweis}
	...
	\end{itemize}
	$\Rightarrow$ Behauptung nach \hyperref[kor:1-5.11]{Korollar 5.11} % todo: check if it is really 5.11, in my notes there is kor 5.10 mentioned but 5.10 is a prop
\end{beweis}
