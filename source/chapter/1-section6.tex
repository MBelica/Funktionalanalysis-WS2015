...
\begin{definition} \index{kompakt} \index{relativ kompakt}
	Sei $(M, d)$ ein metrischer Raum. Eine Menge $K \subseteq M$ hei{\ss}t (folgen-)\begriff{kompakt}, falls es in jeder Folge $(x_{n})_{n \geq 1} \subset K$ eine Teilfolge $(x_{n_{k}})_{}k \geq 1 \subet K$ und ein $x \in K$ gibt, so dass 
