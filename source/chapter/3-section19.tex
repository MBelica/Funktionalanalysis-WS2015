...
\begin{bemerkung*}
	...
	wobei $\mu_{n} = 0$, falls $e_{n} \in \kernn(T), \mu_{n} = \lambda_{m}$ falls $e_{n} = h_{m}$. \\ \\ % todo at 19.11: check if I've understood drawing correctly 
...
Also: $T h_{n} = \lambda_{n} h_{n}$ und $h_{n} \bot \kernn(T)$ nach \hyperref[]{19.10b} \\ 
